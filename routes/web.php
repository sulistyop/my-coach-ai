...
Route::middleware('auth')->group(function () {
	...
	Route::get('/goals-results', [GoalController::class, 'indexGoals'])->name('goals-results');
	Route::post('/store-habits', [GoalController::class, 'storeHabitResult'])->name('store-habits-result');
